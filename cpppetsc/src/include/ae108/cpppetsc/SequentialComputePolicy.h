...
MPI_Comm SequentialComputePolicy::communicator() { return PETSC_COMM_SELF; }

void SequentialComputePolicy::handleError(const PetscErrorCode code) {
  CHKERRABORT(communicator(), code);
}

bool SequentialComputePolicy::isPrimaryRank() { return true; }
} // namespace cpppetsc
} // namespace ae108