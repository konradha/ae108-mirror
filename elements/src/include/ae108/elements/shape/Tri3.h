...
struct Tri3 : ShapeBase<std::size_t, double, 2, 3> {};

AE108_ELEMENTS_SHAPE_DEFINE_VALUE(Tri3, {{
                                            1 - xi[0] - xi[1],
                                            xi[0],
                                            xi[1],
                                        }});

AE108_ELEMENTS_SHAPE_DEFINE_GRADIENTS(Tri3, {{
                                                {{-1., -1.}},
                                                {{1., 0.}},
                                                {{0., 1.}},
                                            }});

AE108_ELEMENTS_SHAPE_DEFINE_POINTS(Tri3, {{
                                             {{0., 0.}},
                                             {{1., 0.}},
                                             {{0., 1.}},
                                         }});
